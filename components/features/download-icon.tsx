    ...
    >
      <div className="flex h-full w-full flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref} className="p-0 h-16 w-16 bg-new">
            <Icons.user />
          </Circle>
        </div>
        <div className="flex flex-col justify-center items-center">
          <Circle ref={div6Ref} className="p-0 h-16 w-16 bg-new">
        ...
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} className="p-0 h-16 w-16 bg-new">
          ...
          <Circle ref={div2Ref} className="p-0 h-16 w-16 bg-new">
            <div className="relative h-11 w-11">
              <Image
                src="/jpeg-icon.png"
                alt="jpeg"
          ...
          <Circle ref={div3Ref} className="p-0 h-16 w-16 bg-new">
            <div className="relative h-11 w-11">
              <Image
                src="/png-icon.png"
                alt="png"
          ...
          <Circle ref={div4Ref} className="p-0 h-16 w-16 bg-new">
            <div className="relative h-11 w-11">
              <Image
                src="/json-icon.png"
                alt="json"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1607_5"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_1607_5"
            result="shape"
          />
        </filter>
      </defs>
