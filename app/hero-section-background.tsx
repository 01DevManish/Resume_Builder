...
const HeroSectionBackground = ({
  ...
  const svg = `
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' stroke='${color}' strokeWidth='${strokeWidth}' fill-opacity='0.4' >
  ...
  return (
    <div
      className={`pointer-events-none absolute inset-0 left-0 top-0 flex h-full w-full z-10 ${className}`}
      style={{
